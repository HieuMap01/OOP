/*3. q Game:
Trong thử thách lập trình này, bạn sẽ tạo một trò chơi đố đơn giản cho hai người chơi. Chương trình sẽ hoạt động như sau:
- Mỗi người chơi cần trả lời liên tiếp năm câu hỏi, tổng cộng 2 người trả lời 10 câu hỏi. 
Mỗi lần hỏi, chương trình sẽ hiển thị một câu đố kèm 4 đáp án để chọn, người chơi nhập lựa chọn, 
chương trình hiển thị câu đố tiếp theo. Người 1 chơi xong thì đến lượt người 2. 
Mỗi câu hỏi chỉ có 1 đáp án đúng. Mỗi lần chọn đúng đáp án thì người chơi được 1 điểm.
- Sau khi 2 người chơi xong, chương trình sẽ hiển thị số điểm mà mỗi người chơi kiếm được và tuyên bố người thắng trò chơi.
Để cài đặt trò chơi này, hãy thiết kế một lớp Question chứa dữ liệu cho một câu hỏi đố.
Lớp Question cần có các biến thành viên sau:
- Một câu hỏi đố
- Câu trả lời 1
- Câu trả lời 2
- Câu trả lời 3
...
Lớp Question cũng cần có hàm tạo và setter getter (sinh viên tự lựa chọn kiểu và số lượng).
Chương trình sẽ tạo một mảng gồm 10 đối tượng Question, ứng với 10 câu đố. 
Sau đó nhập tên 2 người chơi, cho 2 người chơi và thông báo kết quả.
*/
